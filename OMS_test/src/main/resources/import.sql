...
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,0,'marytest','Mary','S.','customer1','qwerty',1,1,4);

insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,0,'bobtest','Bob','B.','merch1','qwerty',2,2,2);
