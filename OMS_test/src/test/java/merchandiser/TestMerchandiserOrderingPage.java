...
public class TestMerchandiserOrderingPage extends BaseTest {
	...
	private static String SEARCH_FOR_ORDER_BY_TEXT_FROM_SRS = "Search for orders by:";
	...
	private static String COLUMN_MAXDISCOUNT_TEXT_FROM_SRS = "Max Discount";
	...
	public void testOrderNameText() {
		assertEquals(COLUMN_ORDERNAME_TEXT_FROM_SRS,
				MERCH_ORDERING_PAGE.getOrderNameItemText());
	}
