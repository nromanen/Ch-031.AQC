...
insert into CustomerTypes(Discount,MaxRange,MinRange,TypeName) values(5,3000,1000,'Silver');
insert into CustomerTypes(Discount,MaxRange,MinRange,TypeName) values(10,10000,3000,'Gold');
insert into CustomerTypes(Discount,MaxRange,MinRange,TypeName) values(15,null,10000,'Platinum');
...
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','ivanka','horoshko','iva','qwerty',1,4,1);
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','myroslav','shram','myroslav','qwerty',2,3,1);
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','marko','bekhta','marko','qwerty',3,2,1);
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','vitalik','nobis','vitalik','qwerty',4,1,1);
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','orest','vovchack','orest','qwerty',1,4,1);
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','roman','nazarevuch','romanN','qwerty',2,3,1);
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','roman','svustyn','romanS','qwerty',3,2,1);
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','firstName1','lastName1','login1','qwerty',1,1,2);
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','firstName2','lastName2','login2','qwerty',1,1,3);
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','firstName3','lastName3','login3','qwerty',1,1,4);
insert into Users(IsUserActive,Balance,Email,FirstName,LastName,Login,Password,CustomerTypeRef,RegionRef,RoleRef) values(true,10,'mail','firstName4','lastName4','login4','qwerty',1,2,4);
