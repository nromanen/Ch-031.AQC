...
public abstract class AbstractListUsersController {
	...
	protected Integer definePage(final SearchModel searchModel, final ModelMap modelMap) {
	    	Integer pageSize = Integer.parseInt(searchModel.getPageSize());
	    	Integer size = Integer.parseInt(searchModel.getRecordsFound());
	    	Integer startPosition = Integer.parseInt(searchModel.getPageStartPosition());
