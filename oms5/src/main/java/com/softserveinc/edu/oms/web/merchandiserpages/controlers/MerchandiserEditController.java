 ...
 */
@Controller
public class MerchandiserEditController extends AbstractController {
	// Fields
	 ...
	 */
	private final static String CONTROLLER_NAME = "merchandiserEdit.htm";
	 ...
	 */
	@RequestMapping(value = CONTROLLER_NAME)
	public String handleMerchandiserController(final HttpServletRequest request,
		     final ModelMap modelMap) {
		MerchandiserEditHandler handler = new MerchandiserEditHandler(orderService, orderStatusService);
