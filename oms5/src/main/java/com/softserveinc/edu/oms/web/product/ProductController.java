...
import com.softserveinc.edu.oms.web.product.model.ListProductModelValidator;
...
public class ProductController {
	...
	@Autowired
	ListProductModelValidator listProductModelValidator;
	...
	public String listProducts(final HttpServletRequest request,
			final ModelMap map, 
			final @ModelAttribute("model") ListProductModel productModel,
		...
		if (request.getParameter(DONE) != null) {
		    	listProductModelValidator.validate(productModel, result);
		    	if(!result.hasErrors()) {
