...
public class RegionService implements IRegionService {
	...
	@Transactional
	@Override
	public List<Region> findRegionByName(final String regionName, final UserSelectWayCondition condition) {
		return regionDao.findRegionByName(regionName, condition);
	}
}
