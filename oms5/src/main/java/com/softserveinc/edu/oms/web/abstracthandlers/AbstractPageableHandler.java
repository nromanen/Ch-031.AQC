...
public abstract class AbstractPageableHandler extends AbstractHandler {
	...
	/**
	 * PageJspType enumerable value that used in handlerLogic method for deciding
	 ...
	 */
	@Override
	protected final String handlerLogic(HttpServletRequest request,
										ModelMap modelMap) throws Exception {
		// Create pageModel object
		PageModel pageModel = new PageModel(getNumberOfAllElementsForPageModel(request), request);
		// Set page data
		switch (pageJspType) {
		case JspWithAjax:
	...
	/**
	 * Get PageJspType enumerable value that used in handlerLogic method for
	...
	/**
	 * Set PageJspType enumerable value that used in handlerLogic method for
	 * deciding what page data set in modelMap.
	 * 
	 * @param pageJspType
