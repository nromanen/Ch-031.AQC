/**
 * MerchandiserShowPageController
 *
 * Version 1.0
 *
 * Date 15.09.11
...
import com.softserveinc.edu.oms.web.AbstractController;
 ...
 */
@Controller
public final class MerchandiserShowPageController extends AbstractController {
	// Fields
	 ...
	 */
	private final static String CONTROLLER_WITH_AJAX_URL = "merchandiser.htm";
	private final static String CONTROLLER_WITHOUT_AJAX_URL = "merchandiserWithoutAjax.htm";
	private final static String PAGEABLE_CONTROLLER_URL = "merchandiserPageable.htm";
	 ...
	 */
	@RequestMapping(value = CONTROLLER_WITH_AJAX_URL)
	public String handleMerchandiserController(final HttpServletRequest request, final ModelMap modelMap) {
		MerchandiserPageableHandler handler = new MerchandiserPageableHandler(orderService, orderItemService);
	 ...
	 * @return JSP name to show
	 */
	@RequestMapping(value = CONTROLLER_WITHOUT_AJAX_URL)
	public String handleMerchandiserWithoutAjaxController(final HttpServletRequest request, final ModelMap modelMap) {
		MerchandiserPageableHandler handler = new MerchandiserPageableHandler(orderService, orderItemService);
	 ...
	 * @return JSP name to show
	 */
	@RequestMapping(value = PAGEABLE_CONTROLLER_URL)
	public String handleMerchandiserPageableController(final HttpServletRequest request, final ModelMap modelMap) {
		MerchandiserPageableHandler handler = new MerchandiserPageableHandler(orderService, orderItemService);
