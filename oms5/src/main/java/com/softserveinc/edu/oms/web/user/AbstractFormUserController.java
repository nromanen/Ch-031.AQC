...
public abstract class AbstractFormUserController {
	...
	protected EditUserValidator editUserValidator;
	...
	@Autowired
	public void setAddUserValidator(AddUserValidator addUserValidator) {
		this.addUserValidator = addUserValidator;
	}

	@Autowired
	public void setEditUserValidator(EditUserValidator editUserValidator) {
