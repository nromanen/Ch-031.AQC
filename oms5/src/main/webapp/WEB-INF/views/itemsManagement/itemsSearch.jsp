...
<fieldset>
	...
	<form:form id="searchForm" method="GET" action="${searchItems}"
		...
		<form:select id="field" path="selectField" >
			<form:options  items="${selectFields}"  itemLabel="displayName" />
		</form:select>
...
<p style="margin: 0; text-align: right;">
	<a href="${resizeItemsList}" style="color: blue"><spring:message code="uSearch.show" /> ${productSearchModel.pageSizeChange}
