<div align="Center" style="margin: 0; text-align: center;">
	<form action="changePage.htm" style="margin: 0; text-align: center; display: inline;">
		...
		<input id="first" type="submit"
			...
			<c:if test="${!searchFilter.isFirstPage()}"> disabled="disabled" </c:if> />
	</form>

	<form action="changePage.htm" style="margin: 0; text-align: center; display: inline;">
		<input type="hidden" name="pageCommand" value="previous"
			style="display: inline;" />
		<input id="previous" type="submit"
			value="<spring:message code="uNavi.back" />" name="previous"
			<c:if test="${!searchFilter.isPreviousPage()}"> disabled="disabled" </c:if> />
	</form>
	...
	<form action="changePage.htm" style="margin: 0; text-align: center; display: inline;">
		...
		<input id="next" type="submit"
			...
			<c:if test="${!searchFilter.isNextPage()}"> disabled="disabled" </c:if> />
	</form>
	...
	<form action="changePage.htm" style="margin: 0; text-align: center; display: inline;">
		...
		<input id="last" type="submit"
			...
			<c:if test="${!searchFilter.isLastPage()}"> disabled="disabled" </c:if> />
	</form>
</div>
