...
<script type="text/javascript" charset="utf-8">
	...
	$(function() {
		...
		$('#dateDays').datePicker({
			startDate : new Date()
		}).val('<c:out value="${preferableDeliveryDate}" />').trigger('change');
...
<div id="edit">
	<fieldset style="height: 317px; margin-top:-25px; margin-bottom:-9px">
		...
		<form name="saveButton" id="saveButton" action="orderItemsSave.htm"
			...
			<table>
				...
				<tr>
					...
					<td><input name="deliveryDate" type="text" class="date-pick" id="dateDays" style="width: 110px"  />
					</td>
				</tr>
				<tr>
