...
<fieldset>
	...
	<form:form id="searchForm" method="GET" action="${searchUsers}"
		...
		<form:select id="field" path="selectField" >
			<form:options  items="${userSelectFields}"  itemLabel="displayText" />
		</form:select>
		<form:select id="condition" path="selectCondition" >
			<form:options  items="${selectConditions}"  itemLabel="displayText" />
		</form:select>
		<form:input id="searchField" path="searchValue" maxlength="25" style="width: 240px;" />
