...
<div id="edit">
	<h3><spring:message code="uEditform.header" /> ${userModel.login}</h3>
	<span><spring:message code="uEditform.leaveBlankPass" /></span>
	<form:form method="POST" commandName="userModel"
		...
		<table>
			...
			<tr>
				<td><spring:message code="uEditform.newPassword" /></td>
		...
		<input type="submit" value="<spring:message code="uEditform.bSumbit" />" /> <!-- onclick="return processSubmit()" -->
